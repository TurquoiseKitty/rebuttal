...
if __name__ == "__main__":
    ...
    for n_comp in [15, 30, 40, 57]:
        ...
        for repeat in range(5):
            ...
            N_model_train = int(len(y_reshaped) * 0.95)
            N_recalibration = int(len(y_reshaped) * 0.05)
    ...
    df.to_csv(os.getcwd()+"/Experiments/EXP4/record_bin/OnlineNews_vanillaKernel_covSelect_addition.csv",index=False)
