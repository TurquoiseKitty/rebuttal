...
from data_utils import get_uci_data, common_processor_UCI, seed_all, OnlineNews, normalize
...
if __name__ == "__main__":
    ...
    for modelname in [ "HNN_BeyondPinball"]:
        ...
        base_train_config["bat_size"] = 256
    ...
    # df.to_csv(os.getcwd()+"/Experiments/EXP4/record_bin/OnlineNews_muSigma_benchmarks.csv",index=False)
    df.to_csv(os.getcwd()+"/Experiments/EXP4/record_bin/OnlineNews_CCL.csv",index=False)
